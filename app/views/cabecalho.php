<header class="topo">
			<div class="conteudo">
				...
				<a href="<?php echo URL_BASE ?>" class="logo"><img src="<?php echo URL_BASE?>assets/img/logo.png" width="160" height="40"></a>
				<nav class="menu">
					<ul>
						<li><a href="<?php echo URL_BASE ?>"><i class="ico home"></i>Home</a></li>
						<li><a href="<?php echo URL_BASE."contato/create" ?>"><i class="ico cad"></i>Novo cadastro</a></li>
						<li><a href="<?php echo URL_BASE."contato" ?>"><i class="ico lista"></i>Lista de cadastro</a></li>
